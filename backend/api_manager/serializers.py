...
class OrderSerializer(serializers.HyperlinkedModelSerializer):
    class Meta:
        model = Order
        fields = ['customer', 'order_pu', 'order_del', 'time_placed', 'order_id', 'order_type', 'order_complete', 'time_open', 'time_to_complete']
...
class PickupSerializer(serializers.HyperlinkedModelSerializer):
    class Meta:
        model = Pickup
        fields = ['pickup_id', 'pu_contact', 'pu_location', 'pu_arrival_time', 'pu_depart_time']

class DeliverySerializer(serializers.HyperlinkedModelSerializer):
    class Meta:
        model = Delivery
        fields = ['delivery_id', 'del_contact', 'del_location', 'del_arrival_time', 'del_depart_time']